...
use App\Http\Livewire\Pages\EnterRequests;
use App\Http\Livewire\Register\Create;
use App\Http\Livewire\Register\Enter;
use App\Http\Livewire\Register\EnterOrCreate;
...
Route::middleware('auth')->group(function () {
    ...
    Route::name('studio.')->prefix('studio')->group(function () {
        Route::view('/create', 'pages.studio.create')->name('create');
